...
| Multi-agent single-key leases + conflicts | COGNITIVE_OS_EXTENSIONS E5 | implemented | `StoreHandle::ensure_user_write_allowed` choke; MCP remember/update | `cognitive_os_acceptance::e5_lease_blocks_remember_handle_tool` | Single-key TTL; conflict via raw store |
