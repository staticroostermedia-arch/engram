...
**Read first:** [docs/AGENT_MEMORY_CONTRACT.md](docs/AGENT_MEMORY_CONTRACT.md) · **All 86 tools:** [docs/TOOL_DECISION_MAP.md](docs/TOOL_DECISION_MAP.md) · **JIT deformation:** [docs/DEFORMATION_PLAYBOOKS.md](docs/DEFORMATION_PLAYBOOKS.md) · **Harness injection:** [docs/HARNESS_INJECTION.md](docs/HARNESS_INJECTION.md) · **Harness (shipped):** [docs/HARNESS_INJECTION.md](docs/HARNESS_INJECTION.md) · [docs/SUBSTRATE_WINS_PLAN.md](docs/SUBSTRATE_WINS_PLAN.md) (historical)
...
- **Do not delete MCP tools** — tier in documentation only; 86 tools remain for power users (82 `mcp_engram_*` + 4 linguistic).
