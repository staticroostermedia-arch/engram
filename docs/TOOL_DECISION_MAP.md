# Tool Decision Map — All 104 MCP Tools
...
Engram exposes **104 tools** (100 `mcp_engram_*` + 4 linguistic; source: mcp.rs `tool_list()`). Do not call all 104 every session. Use this map to pick **one path** per situation. JIT orchestration: [`DEFORMATION_PLAYBOOKS.md`](DEFORMATION_PLAYBOOKS.md). Cognitive OS: [`COGNITIVE_OS_EXTENSIONS.md`](COGNITIVE_OS_EXTENSIONS.md).
