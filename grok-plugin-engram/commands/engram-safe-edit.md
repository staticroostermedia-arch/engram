...
Run the **safe code edit** ritual (`processes/ritual/safe-code-edit.toml`):
...
**Few-shot examples (copy exact JSON):**

```json
{"path":"/home/user/Engram/crates/engram-server/src/mcp.rs","decision":"Add safe_edit composite tool","why":"Agent tool fidelity goal","arc_delta":"delta: registered handler","goal_context":"goal:agent_tool_fidelity_v1"}
```

```json
{"path":"/home/user/Engram/docs/AGENT_MEMORY_CONTRACT.md","decision":"Refresh 8-tool examples","why":"Mirror hardened few-shots in docs","run_verify":true}
```
